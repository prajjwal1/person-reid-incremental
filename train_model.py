...
def main():
    ...
    if args.opt == 'sgd':
        optimizer = optim.SGD(net.parameters(), lr=1e-1,momentum=0.9,weight_deacy=1e-4)
    elif args.opt == 'adam':
        optimizer = optim.Adam(net.paramters(), weight_decay=1e-4)
    elif args.opt =='rmsprop':
        optimzer = optim.RMSprop(net.parameters(), weight_decay=1e-4)
